...
TriGuard is the first framework that supports **private and lossless** triangle counting on **streaming directed graphs**, securely handling **both cycle triangles and flow triangles**.
...
- return **triangle counts** (cycle + flow)
---
